...
print("\n\r CNN (CPU) Train Time : ", CNNCPUTrainTime.total_seconds(), "s")
print("CNN (CPU) Test Time :", CNNCPUTestTime.total_seconds() , "s")
print("\n\r CNN (GPU) Train Time : ", CNNGPUTrainTime.total_seconds(), "s")
print("CNN (GPU) Test Time :", CNNGPUTestTime.total_seconds() , "s")

'''
print("\n\r CNN (GPU) Train Time : ", RNNGPUTrainTime.total_seconds(), "s")
print("CNN (GPU) Test Time :", RNNGPUTestTime.total_seconds() , "s")
